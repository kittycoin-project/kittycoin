...
std::string HelpMessage()
{
    string strUsage = _("Options:") + "\n" +
        ...
        "  -port=<port>           " + _("Listen for connections on <port> (default: 1312 or testnet: 11312)") + "\n" +
        ...
        "  -rpcport=<port>        " + _("Listen for JSON-RPC connections on <port> (default: 1213 or testnet: 11213)") + "\n" +
        ...
        "\n" + _("SSL options: (see the Kittycoin Wiki for SSL setup instructions)") + "\n" +
