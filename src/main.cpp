...
#if defined(NDEBUG)
# error "Kittycoin cannot be compiled without assertions."
#endif
...
uint256 hashGenesisBlock("0x453fa29cc0da81df2afc2e8bab7ca661cd89463cb36fb37ea64289de8e48a22c");
...
int64 static GetBlockValue(int nHeight, int64 nFees)
{
    ...
    nSubsidy >>= (nHeight / 500000); // Kittycoin: 840k blocks in ~4 years

    return nSubsidy + nFees;
}

static const int64 nTargetTimespan = 3 * 24 * 60 * 60; // Kittycoin: 3.5 days
static const int64 nTargetSpacing = 2 * 60; // Kittycoin: 2.5 minutes
...
bool CBlock::CheckBlock(CValidationState &state, bool fCheckPOW, bool fCheckMerkleRoot) const
{
    ...
    // Kittycoin: Special short-term limits to avoid 10,000 BDB lock limit:
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x997182890aacc5948103cddaeb34ca927140e84d0d9e08247239810422f457d5");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        // Genesis block
        const char* pszTimestamp = "02/05/2021 - Kitty to the moon - Paris";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        txNew.vin[0].scriptSig = CScript() << 486604799 << CBigNum(4) << vector<unsigned char>((const unsigned char*)pszTimestamp, (const unsigned char*)pszTimestamp + strlen(pszTimestamp));
        txNew.vout[0].nValue = 30 * COIN;
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("04c8d8cb7f215c1d4915c9f72ec6de5e6b2af54ed9ba1e3cdd208c163da0e9547b0cd0d737e8df29a2d3a97663d9d7caf9b0d76aea9f11872d17d4b28d592716ac") << OP_CHECKSIG;
        CBlock block;
        block.vtx.push_back(txNew);
        block.hashPrevBlock = 0;
        block.hashMerkleRoot = block.BuildMerkleTree();
        block.nVersion = 1;
        block.nTime    = 1619988385;
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 2085774998;

        if (fTestNet)
        {
            block.nTime    = 1619988361;
            block.nNonce   = 387198424;
        }
...
if (true && block.GetHash() != hashGenesisBlock)
        ...
        assert(block.hashMerkleRoot == uint256("0xcef3834b68129f82a909875497b8135b051fe322f917263462b589839dbdb1f8"));
        block.print();
...
unsigned char pchMessageStart[4] = { 0xfl, 0xc1, 0xb3, 0xde }; // Kittycoin: increase each by adding 2 to bitcoin's value.
